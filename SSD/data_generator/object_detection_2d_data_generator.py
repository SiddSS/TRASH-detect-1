...
class DataGenerator:
    ...
    #                     # Transform the original class ID to fit in the sequence of consecutive IDs.
    #                     class_id = self.cats_to_classes[cat_id]
    #                     # (480/shape[1]*bounding[1], 300/shape[0]*bounding[0]), (480/shape[1]*bounding[[3], 300/shape[0]*bounding[2])
    #                     # (min_x,min_y),(max_x,max_y)

    #                     ymin = annotation['bbox'][0]
    #                     xmin = annotation['bbox'][1]
    ...
    #                     # ymax =annotation['bbox'][2]
    #                     # xmax =annotation['bbox'][3]

    #                     # xmin = (480/image_width)*xmin_real   #hardcoding the final image size 480X300
    #                     # ymin = (300/image_height)*ymin_real
    #                     # xmax = (480/image_width)*xmax_real   #hardcoding the final image size 480X300
    #                     # ymax = (300/image_height)*ymax_real
