...
class AnchorBoxes(Layer):
    ...
    def call(self, x, mask=None):
        ...
        if K.image_data_format() == 'channels_last':
            ...
            # print("batch_size: {}, feature_map_height: {}, feature_map_width: {}, feature_map_channels: {}".format(batch_size, feature_map_height, feature_map_width, feature_map_channels))
