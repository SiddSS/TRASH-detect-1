...
def build_model(image_size,
                ...
                max_scale=0.9,
                scales=None,
                aspect_ratios_global=[0.25,0.5, 1.0, 2.0,4.0],
...
# adding 64(add_8),128,128,64
    ...
    conv_add_8 = Conv2D(64, (3, 3), strides=(1, 1), padding="same", kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv_add_8')(pool3)
    conv_add_8 = BatchNormalization(axis=3, momentum=0.99, name='bn8')(conv_add_8)
    conv_add_8 = ELU(name='elu8')(conv_add_8)
    pool_add_8 = MaxPooling2D(pool_size=(2, 2), name='pool8')(conv_add_8)
    ...
    pool_add_9 = MaxPooling2D(pool_size=(2, 2), name='pool9')(conv_add_9)
    ...
    pool_add_10 = MaxPooling2D(pool_size=(2, 2), name='pool10')(conv_add_10)
    ...
    pool_add_11 = MaxPooling2D(pool_size=(2, 2), name='pool11')(conv_add_11)


    #------------------------------------------------

    conv4 = Conv2D(64, (3, 3), strides=(1, 1), padding="same", kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv4')(pool_add_11)
    ...
    classes11 = Conv2D(n_boxes[0] * n_classes, (3, 3), strides=(1, 1), padding="same", kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='classes11')(conv_add_11)
    ...
    boxes11 = Conv2D(n_boxes[0] * 4, (3, 3), strides=(1, 1), padding="same", kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='boxes11')(conv_add_11)
    ...
    anchors11 = AnchorBoxes(img_height, img_width, this_scale=scales[0], next_scale=scales[1], aspect_ratios=aspect_ratios[0],
                           two_boxes_for_ar1=two_boxes_for_ar1, this_steps=steps[0], this_offsets=offsets[0],
                           clip_boxes=clip_boxes, variances=variances, coords=coords, normalize_coords=normalize_coords, name='anchors11')(boxes11)    
    ...
    classes11_reshaped = Reshape((-1, n_classes), name='classes11_reshape')(classes11)
    ...
    boxes11_reshaped = Reshape((-1, 4), name='boxes11_reshape')(boxes11)
    boxes4_reshaped = Reshape((-1, 4), name='boxes4_reshape')(boxes4)
    boxes5_reshaped = Reshape((-1, 4), name='boxes5_reshape')(boxes5)
    boxes6_reshaped = Reshape((-1, 4), name='boxes6_reshape')(boxes6)
    boxes7_reshaped = Reshape((-1, 4), name='boxes7_reshape')(boxes7) 
    # Reshape the anchor box tensors, yielding 3D tensors of shape `(batch, height * width * n_boxes, 8)`
    anchors11_reshaped = Reshape((-1, 8), name='anchors11_reshape')(anchors11)
    ...
    classes_concat = Concatenate(axis=1, name='classes_concat')([classes11_reshaped,
                                                                 classes4_reshaped,
                                                                 classes5_reshaped,
                                                                 classes6_reshaped,
                                                                 classes7_reshaped])
    ...
    boxes_concat = Concatenate(axis=1, name='boxes_concat')([boxes11_reshaped,
                                                             boxes4_reshaped,
                                                             boxes5_reshaped,
                                                             boxes6_reshaped,
                                                             boxes7_reshaped])
    ...
    anchors_concat = Concatenate(axis=1, name='anchors_concat')([anchors11_reshaped,
                                                                 anchors4_reshaped,
                                                                 anchors5_reshaped,
                                                                 anchors6_reshaped,
                                                                 anchors7_reshaped])
    ...
    if return_predictor_sizes:
        ...
        predictor_sizes = np.array([classes11._keras_shape[1:3],
